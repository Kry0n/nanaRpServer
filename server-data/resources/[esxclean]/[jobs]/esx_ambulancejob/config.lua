...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(355.7, -596.4, 27.79),
			sprite = 61,
			scale  = 1.2,
			color  = 2
		},
		...
		FastTravels = {
			...
			{
				--to the top floor
				From = vector3(340.23, -595.38, 27.79),
				To = { coords = vector3(342.66, -585.5, 74.17), heading = 0.0 },
				Marker = { type = 1, x = 2.0, y = 2.0, z = 0.5, r = 102, g = 0, b = 102, a = 100, rotate = false }
			},
			{
				--to the 1 floor
				From = vector3(339.89, -584.72, 74.17),
				To = { coords = vector3(336.73, -594.18, 28.79), heading = 0.0 },
				Marker = { type = 1, x = 2.0, y = 2.0, z = 0.5, r = 102, g = 0, b = 102, a = 100, rotate = false }
			},
			-- not ok below
			{
