...
RegisterNetEvent('anubis:AddPlayerBlipEMS')
AddEventHandler('anubis:AddPlayerBlipEMS', function()
 TriggerEvent('eblips:add', {name = "EMS", src = source, color = 6})
end)

RegisterNetEvent('anubis:AddPlayerBlipPolice')
AddEventHandler('anubis:AddPlayerBlipPolice', function()
 TriggerEvent('eblips:add', {name = "Police", src = source, color = 1})
end)