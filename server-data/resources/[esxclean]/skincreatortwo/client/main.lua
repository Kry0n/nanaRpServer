...
RegisterNetEvent('skincreatortwo:loadMenu')
AddEventHandler('skincreatortwo:loadMenu', function()
...
RegisterNetEvent('skincreatortwo:openSaveableMenu')
AddEventHandler('skincreatortwo:openSaveableMenu', function(submitCb, cancelCb)
	ShowSkinCreator(true)
end)
