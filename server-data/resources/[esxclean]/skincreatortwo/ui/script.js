$(document).ready(function(){
  ...
  $('input').change(function(){
    $.post('http://skincreatortwo/updateSkin', JSON.stringify({
      value: false,
      // Face
  ...
  $(document).keypress(function(e) {
    if(e.which == 97){ // A pressed
      $.post('http://skincreatortwo/rotaterightheading', JSON.stringify({
        value: 10
      }));
    }
    if(e.which == 101){ // E pressed
      $.post('http://skincreatortwo/rotateleftheading', JSON.stringify({
        value: 10
      }));
    }
  });
  ...
  $('#tabs label').on('click', function(e){
    //e.preventDefault();
    $.post('http://skincreatortwo/zoom', JSON.stringify({
