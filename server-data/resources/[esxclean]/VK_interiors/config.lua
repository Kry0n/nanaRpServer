INTERIORS = {
    -- HOPITAL
    [1] = {id = 1, x = 272.86, y = -1358.81, z = 24.53, h = 50.37, name = "Hopîtal", destination = {2,3}},
    ...
    -- FIB
    [4] = {id = 4, x = 136.17451477051, y = -761.84014892578, z = 45.752010345459, h = 161.11303710938, name = "Etage n°1", destination = {5}},
    [5] = {id = 5, x = 136.25639343262, y = -761.49816894531, z = 242.15199279785, h = 160.31993103027, name = "Etage n°49", destination = {4}},
    ...
    -- BAHMAS MAMAS
    [8] = {id = 8, x = -1388.9272460938, y = -586.08123779297, z = 30.219741821289, h = 35.407787322998, name = "Sortir", destination = {9}},
    [9] = {id = 9, x = -1394.5030517578, y = -596.09210205078, z = 30.319562911987, h = 205.4248046875, name = "Entrer", destination = {8}},
