...
Config.Strings = {
	ExitVehicle = "退出車輛加油",
	EToRefuel = "按下 ~g~E ~w~給車輛加油",
	JerryCanEmpty = "汽油桶是空的",
	FullTank = "油箱滿了",
	PurchaseJerryCan = "按下 ~g~E ~w~購買一個汽油桶 ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "按下 ~g~E ~w~取消加油",
	CancelFuelingJerryCan = "按下 ~g~E ~w~取消加油",
	NotEnoughCash = "現金不夠",
	RefillJerryCan = "按下 ~g~E ~w~ 為汽油桶裝油 ",
	NotEnoughCashJerryCan = "沒有足夠的現金來補充汽油桶裝油可以",
	JerryCanFull = "汽油桶滿了",
	TotalCost = "花費",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "按下 ~g~E ~w~ 買一個汽油桶"
	Config.Strings.RefillJerryCan = "按下 ~g~E ~w~ 裝滿油汽油桶"
end
