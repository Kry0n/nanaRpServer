...
--[[Local/Global]]--
local clothingShops = {
    { name="服飾店", color=24, id=73, x=72.2545394897461,  y=-1399.10229492188, z=29.3761386871338},
    { name="服飾店", color=24, id=73, x=-703.77685546875,  y=-152.258544921875, z=37.4151458740234},
    { name="服飾店", color=24, id=73, x=-167.863754272461, y=-298.969482421875, z=39.7332878112793},
    { name="服飾店", color=24, id=73, x=428.694885253906,  y=-800.1064453125,   z=29.4911422729492},
    { name="服飾店", color=24, id=73, x=-829.413269042969, y=-1073.71032714844, z=11.3281078338623},
    { name="服飾店", color=24, id=73, x=-1447.7978515625,  y=-242.461242675781, z=49.8207931518555},
    { name="服飾店", color=24, id=73, x=11.6323690414429,  y=6514.224609375,    z=31.8778476715088},
    { name="服飾店", color=24, id=73, x=123.64656829834,   y=-219.440338134766, z=54.5578384399414},
    { name="服飾店", color=24, id=73, x=1696.29187011719,  y=4829.3125,         z=42.0631141662598},
    { name="服飾店", color=24, id=73, x=618.093444824219,  y=2759.62939453125,  z=42.0881042480469},
    { name="服飾店", color=24, id=73, x=1190.55017089844,  y=2713.44189453125,  z=38.2226257324219},
    { name="服飾店", color=24, id=73, x=-1193.42956542969, y=-772.262329101563, z=17.3244285583496},
    { name="服飾店", color=24, id=73, x=-3172.49682617188, y=1048.13330078125,  z=20.8632030487061},
    { name="服飾店", color=24, id=73, x=-1108.44177246094, y=2708.92358398438,  z=19.1078643798828},
    { name="FIB 服飾店", color=58, id=73, x=125.640, y=-763.056, z=45.752},
}
local firstspawn = 0
local lang = 'tc'
local txt = {
...
AddEventHandler("clothing_shop:backPackInfo",function(skin)
    drawNotification("這個包不能裝東西, 比較好的是 :\n31 - $100000$\n41 - 500000$\n45 - 1000000$")
end)

AddEventHandler("clothing_shop:noMoney",function(skin)
    drawNotification("你沒有足夠的金錢")
end)