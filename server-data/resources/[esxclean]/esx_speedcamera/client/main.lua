...
local blips = {
	-- 60KM/H ZONES
	{title="測速照相 (60KM/H)", colour=1, id=1, x = -524.2645, y = -1776.3569, z = 21.3384}, -- 60KM/H ZONE
	
	-- 80KM/H ZONES
	{title="測速照相 (80KM/H)", colour=1, id=1, x = 2506.0671, y = 4145.2431, z = 38.1054}, -- 80KM/H ZONE
	
	-- 120KM/H ZONES
	{title="測速照相 (120KM/H)", colour=1, id=1, x = 1584.9281, y = -993.4557, z = 59.3923}, -- 120KM/H ZONE
	{title="測速照相 (120KM/H)", colour=1, id=1, x = 2442.2006, y = -134.6004, z = 88.7765}, -- 120KM/H ZONE
	{title="測速照相 (120KM/H)", colour=1, id=1, x = 2871.7951, y = 3540.5795, z = 53.0930} -- 120KM/H ZONE
}
								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									if alertPolice == true then
										if SpeedKM > alertSpeed then
											...
											TriggerServerEvent('esx_phone:send', 'police', ' 有人經過測速照相，超過 ' .. alertSpeed.. ' KMH', true, {x =x, y =y, z =z})
										end
									end
									-- ALERT POLICE (END)								
						...
						if (GetPedInVehicleSeat(playerCar, -1) == playerPed) then					
							if hasBeenCaught == false then
								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									TriggerEvent("pNotify:SendNotification", {text = "你在時速80的區域內被拍照了!", type = "error", timeout = 5000, layout = "centerLeft"})
						...
						if (GetPedInVehicleSeat(playerCar, -1) == playerPed) then 
							if hasBeenCaught == false then
								...
								-- VEHICLES ABOVE ARE BLACKLISTED
									...
									TriggerEvent("pNotify:SendNotification", {text = "你在時速120的區域內被拍照了!", type = "error", timeout = 5000, layout = "centerLeft"})
