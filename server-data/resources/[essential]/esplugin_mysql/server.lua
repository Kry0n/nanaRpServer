...
AddEventHandler('es_db:createUser', function(identifier, license, cash, bank, callback)
	...
	MySQL.Async.execute('INSERT INTO users (`identifier`, `money`, `bank`, `group`, `permission_level`, `license`, `isFirstConnection`) VALUES (@identifier, @money, @bank, @group, @permission_level, @license, @isFirstConnection);',
	{
